...
function find(table, where) {
  return (0, _getMysqlConnection2.default)().then(runQuery(sql.find(table, prepareWhere(where)))).then(takeFirst);
}
...
function select(table, where) {
  return (0, _getMysqlConnection2.default)().then(runQuery(sql.find(table, prepareWhere(where)))).then(r => r[0]);
}
